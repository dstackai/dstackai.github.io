...
###### [`registry_auth`](#dstack.api.RegistryAuth) - (Optional) Credentials for pulling a private Docker image.  { #_registry_auth data-toc-label='registry_auth' class='reference-item' }
...
###### [`resources`](#dstack.api.Resources) - (Optional) The resources requirements to run the configuration.  { #_resources data-toc-label='resources' class='reference-item' }
...
###### [`scaling`](#dstack.api.Scaling) - (Optional) The auto-scaling rules. Required if `replicas` is set to a range.  { #_scaling data-toc-label='scaling' class='reference-item' }
...
###### `ide` -  The IDE to run. Supported values include `vscode`, `cursor`, and `windsurf`.  { #ide data-toc-label='ide' class='reference-item' }
###### `version` - (Optional) The version of the IDE. For `windsurf`, the version is in the format `version@commit`.  { #version data-toc-label='version' class='reference-item' }
###### `init` - (Optional) The shell commands to run on startup.  { #init data-toc-label='init' class='reference-item' }
...
###### [`cpu`](#dstack.api.CPU) - (Optional) The CPU requirements.  { #_cpu data-toc-label='cpu' class='reference-item' }
...
###### [`gpu`](#dstack.api.GPU) - (Optional) The GPU requirements.  { #_gpu data-toc-label='gpu' class='reference-item' }
###### [`disk`](#disk) - (Optional) The disk resources.  { #_disk data-toc-label='disk' class='reference-item' }
